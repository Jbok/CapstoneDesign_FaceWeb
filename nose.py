...
def draw_lines(p1, p2):
   cv2.line(image, (shape[p1][0],shape[p1][1]), (shape[p2][0],shape[p2][1]), (255, 0, 0), 1)
   cv2.line(image, (shape[p1][0],shape[p1][1]), (shape[p1][0],shape[p2+1][1]), (255, 0, 0), 1)
   
def result_print(p1,p2):
   draw_lines(p1,p2)
   print("27 and 30: ",cal_degrees(p1,p2))
...
for (i, rect) in enumerate(rects):
   ...
   # 코 27번점에서 (x,y) 좌표 구하고 27번이랑 30번 연결한 선이랑 27번에서 수직으로 내린선 degree
